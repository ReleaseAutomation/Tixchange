 ...
 * <p/>
 * http://localhost/jtixchange_distributed/shop/viewOrder.do
 * <p/>
...
public class BeanAction extends Action {
			...
			if (form != null) {
				...
				if ((method == null) && !"*".equals(methodName)) {
					...
					if (methodName.length() > 1) {
						final int slash = methodName.lastIndexOf("/") + 1;
	...
	/* private Method extracted(ActionForm form, String methodName)
			throws NoSuchMethodException {
		return form.getClass().getMethod(methodName, (Class<?>[])null);
	} */
